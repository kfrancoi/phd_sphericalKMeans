function paramTuning2(varargin)

%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Bag of path experiments %
%%%%%%%%%%Kevin Francoisse%

classicRange = {1e-2 5e-2 1e-1 5e-1 1 3 5 7 10};
classicRangeExt = {{1e-2 1} {5e-2 1} {1e-1 1} {5e-1 1} {1 1} {3 1} {5 1} {7 1} {10 1}};
dataset = {'data/news_3_parameterTuning'};

kernel = {varargin{1}};
p = {classicRangeExt classicRange};
params = p(varargin{2});
...
save(['paramTuningResult_' kernel{1}], 'results');